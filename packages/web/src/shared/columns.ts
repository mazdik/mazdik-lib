...
export function getColumnsPlayers(): ColumnBase[] {
  const columnsPlayers: ColumnBase[] = [
    {
      title: 'Id',
      name: 'id',
      sortable: true,
...
export function getColumnsRank(): ColumnBase[] {
  const columnsRank: ColumnBase[] = [
...
export function getColumnsInventory(): ColumnBase[] {
  const columnsInventory: ColumnBase[] = [
...
export function getTreeColumns(): ColumnBase[] {
  return [
    {
      title: 'Node',
      name: 'node',
