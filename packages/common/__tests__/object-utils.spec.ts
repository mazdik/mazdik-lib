import { getDeepValue } from '../src/utils';
...
describe('getDeepValue', () => {
  ...
  it('should get values one level deep', () => {
    ...
    expect(getDeepValue(data, 'a.value')).toEqual(123);
  });
  ...
  it('should get values two levels deep', () => {
    ...
    expect(getDeepValue(data, 'a.b.value')).toEqual('foo');
  });
  ...
  it('should get array-element two-level deep', () => {
    ...
    expect(getDeepValue(data, 'a.b.0')).toEqual(123);
  ...
  it('should get value of object inside an array-element', () => {
    ...
    expect(getDeepValue(data, 'a.b.0.c')).toEqual(123);
  });
  ...
  it('should get value of object inside a double array-element', () => {
    ...
    expect(getDeepValue(data, 'a.b.0.0')).toEqual(123);
  });
